   ...
   <nav class="navbar">
        ...
        <ul class="log" id="items">
          ...
          <li class="nav-item">
              ...
              <li class="nav-item">
                  <span class="cus_name">Hi! <?php echo $cus_name; ?></span> <a  href="logout.php"><i   class="fa fa-sign-out"></i></a>
              </li>
       </ul>
                    <script>
        ...
        <div class="mobile-view">
            ...
            <li><a href="#hotels"><i class="fa fa-building"></i></a>
           
            </li>
            <li ><a href="#contact"><i class="material-icons">help</i></a>
